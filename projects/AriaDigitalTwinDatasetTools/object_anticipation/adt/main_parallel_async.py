...
high_dot_thresholds = [0.8]  # [0.7, 0.8, 0.9]               # [0.5, 0.6, 0.7, 0.8, 0.9]                 
distance_thresholds = [2, 2.5] # [1.5, 2, 2.5]                        
...
async def main(parameters, rate_limiter):
    ...
    print("Parameters combination is:", parameters)
    try:
            ...
            if args.use_llm and not llm_activated:  
                ...
                if any(object in high_dot_history for object in less_than_2_seconds_dict.keys()): # TODO: make this soft having it as a group of objects that was looking, Red Clock was within a group 
                    ...
                    while not success and retry_count < max_retries:
                        llm_response = await activate_llm(history_log_string, parameters, rate_limiter, prompt_path)
