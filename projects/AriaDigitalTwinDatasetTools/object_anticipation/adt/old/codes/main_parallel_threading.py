...
def run_simulation(parameters):
    try:
        ...
        print(f"Error in processing parameters {parameters}: {e}")
...
if __name__ == "__main__":
    ...
    max_workers = 8  # To approximately have 8 requests per second and has been based on your API rate limits

    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        futures = [executor.submit(main, parameters) for parameters in param_combinations]
